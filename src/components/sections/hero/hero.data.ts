import type { SolutionItemsProps } from "./hero.types";

export const solutionItems: SolutionItemsProps[] = [
  {
    title: "Solar Solutions",
    description: `Harness the power of the sun and embrace clean, renewable energy with our solar solutions.`,
    src: "/solar-solutions.webp",
    alt: "introduction of solar panels",
  },
  {
