...
import { advantagesItems } from "./advantages.data";
      ...
      <LayoutContainer>
        ...
        >
          ...
          <div className="pt-0 md:pt-5 lg:pt-10">
            <h2 className="text-dark mb-[13px] ml-0.5 leading-tight md:leading-snug xl:leading-[67px]">
              Why Choose Us?
            </h2>
          ...
          <AdvantagesList cards={advantagesItems} />
        </div>
      </LayoutContainer>
    </section>
  );
