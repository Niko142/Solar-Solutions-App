...
import {
  ...
  idVariants,
  titleVariants,
} from "@/shared/animations/card.animation";
import type { AdvantageCardProps } from "@/shared/types/advantages.types";
  ...
  return (
    ...
    >
      ...
      <motion.h3
        ...
        className="font-poppins mb-2.5 text-xl/tight md:text-2xl/[29px]"
      >
        {title}
      </motion.h3>
      <motion.p
